...
"                 </th>\n" +
          ...
          "           </a>\n"+
          "            <span class='text-primary fa fa-lock' ng-show='showIcon(row.branch[expandingProperty.field] || row.branch[expandingProperty])' ng-click='showPermissions(row.branch)'></span>\n"+
		  "            <span class='text-primary fa fa-gear' ng-show='showIcon(row.branch[expandingProperty.field] || row.branch[expandingProperty])' ng-click='showProperties(row.branch)'></span>\n"+
 ...
 scope.onSelectItems=function(branch){
	 ...
	 if(prefix==="add"){
		 scope.selectedItems[value]={name:branch.Name,directory:branch.Directory,object:branch.object};
	 }else{
 ...
 scope.showPermissions=function(branch){
	 scope.$parent.doPermissions(branch.object);
 };
 
 scope.showProperties=function(branch){
	 roleId=branch.Directory.substring(0,branch.Directory.indexOf('/'));
	 scope.$parent.showPropertiesPanel(roleId,branch.object);
 };
